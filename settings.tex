...
\newenvironment{bullets}{%
  \begin{list}{}{%
    ...
    \renewcommand{\makelabel}[1]{\textbullet\enspace}}%
  % The lead-in is set as paragraph text after the label rather than inside
  % it, because LaTeX puts the label in an unbreakable box and a long
  % lead-in would run into the right margin instead of wrapping.
  \let\bulletsitem\item
  \renewcommand{\item}[1][]{%
    \bulletsitem[]%
