...
% The appendix carries the smoothing-filter measurements. Its remaining
% sections are still stubs and are commented out inside pages/appendix.tex;
% uncomment them there as they get written, together with the
% cross-reference in chapters/04_approach.tex, Section "Defects found
% during hardening".
\appendix{}
